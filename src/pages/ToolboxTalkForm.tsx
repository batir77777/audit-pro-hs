...
export default function ToolboxTalkForm() {
  ...
  React.useEffect(() => {
    ...
    if (!saved) return;
    const payload = (saved && typeof saved === 'object' && saved.data && typeof saved.data === 'object')
      ? saved.data
      : saved;
  ...
  return (
    <div className="max-w-[1200px] mx-auto space-y-8 pb-24 md:pb-12 px-1 sm:px-2" id="toolbox-talk-report">
