      ...
      >
        ...
        <Card className="border-none shadow-xl">
          <CardHeader className="pb-0">
            <CardTitle className="text-lg font-black uppercase tracking-widest">Sign In</CardTitle>
          ...
          <form onSubmit={handleSignIn}>
            ...
            <CardFooter className="flex flex-col gap-3">
              ...
              <Link
                to="/reset-password"
                className="text-[11px] font-bold uppercase tracking-widest text-slate-500 hover:text-slate-700 text-center"
              >
                Forgot Password?
              </Link>
            </CardFooter>
