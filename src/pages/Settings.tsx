    ...
    <div className="max-w-4xl mx-auto space-y-10 pb-20">
      ...
      <div className="grid gap-8">
          ...
          <CardContent className="p-8 space-y-8">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between p-6 rounded-2xl bg-slate-50 border border-slate-100">
                ...
                <Button variant="outline" size="sm" className="bg-white border-none shadow-sm font-black uppercase text-[10px] tracking-widest text-green-600">Enabled</Button>
              </div>
              <div className="flex items-center justify-between p-6 rounded-2xl bg-slate-50 border border-slate-100">
                <div>
                ...
                <Button variant="outline" size="sm" className="bg-white border-none shadow-sm font-black uppercase text-[10px] tracking-widest text-slate-400">Disabled</Button>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <div className="pt-4 space-y-4">
          <Button variant="outline" className="w-full justify-between group py-8 rounded-2xl border-none bg-white shadow-sm hover:bg-slate-50 transition-all">
            <div className="flex items-center gap-4">
